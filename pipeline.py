...
LUA_SHA1 = get_hash(os.path.join(CWD, 'typepad.lua'))
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/a/a6/Typepad_icon.png" height="50px" title=""/>
        <h2>Typepad <span class="links"><a href="https://www.typepad.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/typepad/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Typepad">Wiki</a></span></h2>
        <p>Archiving Typepad.</p>
    '''
)
